...
if(process.env.DB_ADMIN_HOST) configApp.app.host = process.env.DB_ADMIN_HOST;
if(process.env.DB_ADMIN_PORT) configApp.app.port = process.env.DB_ADMIN_PORT;
if(process.env.DB_ADMIN_PASSWORD) configApp.app.password = process.env.DB_ADMIN_PASSWORD;
if(process.env.DB_ADMIN_LOCALE) configApp.app.locale = process.env.DB_ADMIN_LOCALE;
if(process.env.DB_ADMIN_CONTEXT) configApp.app.context = process.env.DB_ADMIN_CONTEXT;
if(process.env.DB_ADMIN_MONITORING) configApp.app.monitoring = process.env.DB_ADMIN_MONITORING;
...
if(process.env.DB_ADMIN_CONN_NAME && process.env.DB_ADMIN_DB_HOST) {
    if(!process.env.DB_ADMIN_DB_PORT) process.env.DB_ADMIN_DB_PORT = '27017'; // Use the default mongodb port when DB_PORT is not set
    var connectionString = 'mongodb://';
    if(process.env.DB_ADMIN_DB_USERNAME && process.env.DB_ADMIN_DB_PASSWORD && process.env.DB_ADMIN_DB_NAME) {
        connectionString += process.env.DB_ADMIN_DB_USERNAME + ':' + process.env.DB_ADMIN_DB_PASSWORD + '@' + process.env.DB_ADMIN_DB_HOST + ':' + process.env.DB_ADMIN_DB_PORT + '/' + process.env.DB_ADMIN_DB_NAME;
    }else if (process.env.DB_ADMIN_DB_USERNAME && process.env.DB_ADMIN_DB_PASSWORD) {
        connectionString += process.env.DB_ADMIN_DB_USERNAME + ':' + process.env.DB_ADMIN_DB_PASSWORD + '@' + process.env.DB_ADMIN_DB_HOST + ':' + process.env.DB_ADMIN_DB_PORT + '/'
    } else {    
        connectionString += process.env.DB_ADMIN_DB_HOST + ':' + process.env.DB_ADMIN_DB_PORT
    }
    configConnection.connections[process.env.DB_ADMIN_CONN_NAME] = {
        connection_options: {},
...
// set app defaults
var app_host = process.env.DB_ADMIN_HOST || 'localhost';
var app_port = process.env.DB_ADMIN_PORT || 1234;
